 ...
 */
export function ProfileView({ userId, isSelf }: ProfileViewProps) {
        ...
        for (const [index, match] of finishedMatches.entries()) {
            ...
            predictionChildren.push(
                <ResultCard
                    ...
                    // Profil public : libellés neutres, on ne tutoie pas le
                    // lecteur à propos des pronos d'un autre joueur.
